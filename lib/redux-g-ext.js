...
exports.default = function (module) {
    ...
    return {
        ...
        onStatusChange: function onStatusChange(eventName) {
            ...
            var self = this;
            _utils2.default.each(this.config.reduxConfig.events, function (evtDetail, key) {
                _utils2.default.each(evtDetail, function (val) {
                    ...
                    publishFn = function publishFn(e) {
                        ...
                        if (val.extract) {
                            _utils2.default.each(val.extract, function (eventType, key) {
